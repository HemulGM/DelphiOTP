...
uses
  OTP.Contract.Core.SecretGenerator, OTP.Contract.Core.Calculator,
  OTP.Contract.Core.Validator, OTP.Core.SecretGenerator, OTP.Core.Calculator,
  OTP.Core.Validator, OPT.Exception.InvalidToken, OTP.Types;
...
type
  ...
  TAlgorithm = OTP.Types.TAlgorithm;
